...
namespace Contracts.Services.Order
{
    public class Command
    {
        ...
        public record PlaceOrder(string CartId, string CustomerId, Dto.DtoPerson Customer, ulong Total, string PaymentMethod, string Description, IEnumerable<Dto.CartItem> Items) : Message, ICommand;
    }
}
