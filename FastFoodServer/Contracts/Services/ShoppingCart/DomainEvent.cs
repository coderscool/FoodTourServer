...
namespace Contracts.Services.ShoppingCart
{
    ...
    {
        public record CartItemAdd(string CustomerId, string ItemId, string RestaurantId, string DishId, Dto.DtoPerson Restaurant, 
            Dto.DtoDish Dish, Dto.DtoPrice Price, ushort Quantity, string Note, bool CheckOut, long Version) : Message, IDomainEvent;
