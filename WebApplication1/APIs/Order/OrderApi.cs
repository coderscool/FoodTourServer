...
namespace WebApplication1.APIs.Order
{
    public static class OrderApi
    {
        public static IEndpointRouteBuilder MapOrderApiV1(this IEndpointRouteBuilder builder)
        {
            ...
            builder.MapGet("/api/order/detail", ([AsParameters] Queries.GetOrderById query)
                => ApplicationApi.GetAsync<Orderer.OrdererClient, OrderUser>
                    (query, (client, ct) => client.GetOrderDetailAsync(query, cancellationToken: ct)));
